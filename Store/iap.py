"""Chores Pro: the one in-app purchase, and the switch from paid to free.
...
PRODUCT_ID = "com.mattbusel.chores.pro"
NAME = "Chores Pro"
PRICE = "4.99"
DESCRIPTION = "Every kid, your own rewards and the weekly report."  # 55 chars max
REVIEW_NOTE = (
    "Non-consumable, one-time unlock. The app is free for up to two kids with every feature. Pro adds a third "
    "and further kid, your own new rewards, and sharing the weekly summary. It is only offered inside Grown-ups "
    "(behind the parent PIN once set; the demo family PIN is 1234); kids' screens never show a price. To see the "
    "paywall: with two kids added, Grown-ups > Kids > Add a kid, or Grown-ups > Rewards > New reward, or "
    "Grown-ups > Settings > See Pro. Restore purchase is on the paywall and in Grown-ups > Settings under Chores Pro."
)
